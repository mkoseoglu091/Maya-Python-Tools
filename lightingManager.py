...
from functools import partial # lets me create an object that stores what function to use and what arguments are needed
...
def getDock(name='LightingManagerDock'):
    ...
    ptr = wrapInstance(int(qtCtrl), QtWidgets.QTabWidget)
    return ptr
...
class LightWidget(QtWidgets.QWidget):
    ...
    def __init__(self, light):
        ...
        if isinstance(light, string_types):
